...
def test_format_gloss_with_definition():
    from shared.scripts.embed_english_gemma import format_gloss
...
def test_lookup_gloss_known_hit():
    from shared.scripts.embed_english_gemma import lookup_gloss
...
def test_load_glove_vocab_reads_words_only(tmp_path):
    from shared.scripts.embed_english_gemma import load_glove_vocab
...
def test_output_is_up_to_date_missing_file(tmp_path):
    from shared.scripts.embed_english_gemma import output_is_up_to_date
