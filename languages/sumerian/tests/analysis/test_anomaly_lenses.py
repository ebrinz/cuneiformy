...
def test_anomaly_config_is_frozen():
    from framework.analysis.anomaly_framework import AnomalyConfig
...
def test_lens1_ranks_low_cosine_first():
    from framework.analysis.anomaly_lenses import lens1_english_displacement
...
def test_lens3_isolation_is_k_nearest_distance():
    from framework.analysis.anomaly_lenses import lens3_isolation
...
def test_lens2_score_combines_frequency_and_low_top1():
    from framework.analysis.anomaly_lenses import lens2_no_counterpart
...
def test_lens4_jaccard_distance_all_different():
    from framework.analysis.anomaly_lenses import lens4_cross_space_divergence
...
def test_lens5_doppelganger_finds_identical_pair():
    from framework.analysis.anomaly_lenses import lens5_doppelgangers
...
def test_lens6_bridge_score_is_high_when_equidistant():
    from framework.analysis.anomaly_lenses import lens6_structural_bridges
...
def test_render_summary_markdown_contains_all_lenses():
    from framework.analysis.anomaly_framework import render_summary_markdown
...
def test_render_lens1_markdown_has_both_tiers():
    from framework.analysis.anomaly_framework import render_lens1_markdown
...
def test_render_lens5_markdown_shows_histogram_summary():
    from framework.analysis.anomaly_framework import render_lens5_markdown
