...
def test_numeric_claim_recognizer_catches_cosines(tmp_path):
    from languages.sumerian.scripts.docs.consistency import extract_numeric_claims
...
def test_numeric_claims_have_json_path_when_atlas_present(tmp_path):
    ...
    import json
    from languages.sumerian.scripts.docs.consistency import extract_numeric_claims, find_claim_in_atlas
...
def test_extract_cuneiform_codepoints(tmp_path):
    from languages.sumerian.scripts.docs.consistency import extract_cuneiform_codepoints
...
def test_every_cuneiform_has_provenance(tmp_path):
    from languages.sumerian.scripts.docs.consistency import (
