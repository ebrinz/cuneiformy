...
def test_load_corpus_frequency_counts_tokens():
    from languages.sumerian.scripts.coverage_diagnostic import _load_corpus_frequency
...
def test_load_lemma_surface_map_builds_citation_to_surfaces():
    from languages.sumerian.scripts.coverage_diagnostic import _load_lemma_surface_map
...
def test_diagnostic_context_is_frozen():
    from languages.sumerian.scripts.coverage_diagnostic import DiagnosticContext
...
def test_classify_miss_normalization_recoverable_wins():
    from languages.sumerian.scripts.coverage_diagnostic import classify_miss
...
def test_classify_miss_subword_inference_respects_threshold():
    from languages.sumerian.scripts.coverage_diagnostic import classify_miss, _ngrams
...
def test_classify_all_misses_sums_to_total():
    from languages.sumerian.scripts.coverage_diagnostic import classify_all_misses, _ngrams
...
def test_classify_all_misses_empty_input():
    from languages.sumerian.scripts.coverage_diagnostic import classify_all_misses
...
def test_ngrams_respects_min_n_max_n():
    from languages.sumerian.scripts.coverage_diagnostic import _ngrams
...
def test_trained_ngrams_unions_vocab():
    from languages.sumerian.scripts.coverage_diagnostic import _trained_ngrams
...
def test_simulate_ascii_normalize_counts_exact_hits():
    from languages.sumerian.scripts.coverage_diagnostic import simulate_ascii_normalize
...
def test_simulate_lower_min_count_per_threshold_is_monotone_nonincreasing():
    from languages.sumerian.scripts.coverage_diagnostic import simulate_lower_min_count
...
def test_simulate_oracc_lemma_expansion_counts_unique_anchors():
    from languages.sumerian.scripts.coverage_diagnostic import simulate_oracc_lemma_expansion
...
def test_tier2_project_and_nearest_neighbor_identifies_correct_english():
    from languages.sumerian.scripts.coverage_diagnostic import _tier2_nearest_english
...
def test_tier2_score_returns_correctness_flags():
    from languages.sumerian.scripts.coverage_diagnostic import _tier2_score_anchor
...
def test_simulate_morpheme_composition_tier1_counts_anchors_with_all_morphemes_in_vocab():
    from languages.sumerian.scripts.coverage_diagnostic import simulate_morpheme_composition
...
def test_simulate_subword_inference_tier1_counts_above_threshold_overlap():
    from languages.sumerian.scripts.coverage_diagnostic import simulate_subword_inference, _ngrams
...
def test_render_json_schema_version_and_structure():
    from languages.sumerian.scripts.coverage_diagnostic import render_json
...
def test_render_markdown_has_required_sections():
    from languages.sumerian.scripts.coverage_diagnostic import render_markdown
...
def test_run_diagnostic_exits_zero_with_synthetic_inputs(tmp_path, monkeypatch):
    ...
    import languages.sumerian.scripts.coverage_diagnostic as mod
